...
QT_MOC_LITERAL(4, 23, 14), // "onDisconnected"
QT_MOC_LITERAL(5, 38, 11) // "onReadyRead"

    },
    "server\0logMessage\0\0msg\0onDisconnected\0"
    "onReadyRead"
};
...
void server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&server::logMessage)) {
                *result = 0;
                return;
            }
        }
